...
_BOT_WELCOME_MESSAGES = [
    (
        ...
        "Теперь здесь есть сообщество, профиль и Разлом колокола.\n\n"
        "📌 <b>Три шага:</b>\n"
        "1️⃣ <b>бот я</b> — увидишь свой профиль\n"
        "2️⃣ <b>бот стрик</b> — ежедневная награда\n"
        "3️⃣ <b>бот помощь</b> — все команды\n\n"
        "<i>Владелец чата уже получил ранг 👑. Основная игра — в мини-аппе (кнопка ниже).</i>"
    ),
    (
    ...
    (
        ...
        "Разлом колокола — в мини-аппе (кнопка ниже).\n\n"
...
def _welcome_kb() -> types.InlineKeyboardMarkup:
    ...
    b.button(text="🌐 Открыть Разлом колокола", url=MINIAPP_URL)
    return b.as_markup()
