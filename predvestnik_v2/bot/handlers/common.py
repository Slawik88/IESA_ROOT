...
HELP_PAGES = {
    ...
    "admin": (
        ...
        "🛡 <b>Защита / Рест</b>\n"
        "▸ <code>бот рест, @юзер</code> — постоянный рест (иммунитет от чистки)\n"
        "▸ <code>бот защита, @юзер 5д/1ч</code> — временный щит\n"
        "▸ <code>бот снять защиту, @юзер</code> — снять любую защиту\n"
        "  💡 Алиасы «рест»: <code>иммунитет</code>, <code>отдых</code>, <code>абсолют</code>\n\n"
