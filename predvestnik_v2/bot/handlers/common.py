...
HELP_PAGES = {
    ...
    "economy": (
        ...
        "  На что: Алмазная крутка, особые яйца, премиум-корм, обмен на Мору\n\n"
        "🛒 <b>Магазин</b>\n"
    ...
    "items": (
        ...
        "▸ <code>egg_basic</code> — 🥚 Базовое · 8 000 🪙\n"
        "  📍 Магазин · 🎯 80% Common · 19% Rare · 1% Epic\n"
        "▸ <code>egg_silver</code> — 🥈 Серебряное · 28 000 🪙\n"
        "  📍 Магазин · 🎯 50%C / 40%R / 10%E\n"
        "▸ <code>egg_gold</code> — 🪙 Золотое · 120 000🪙/250💎\n"
        "  📍 Магазин · 🎯 75%R / 25%E — никаких Common!\n"
        "▸ <code>egg_mythic</code> — 💎 Мифическое · 500 💎\n"
        "  📍 Магазин · 🎯 40%R / 60%E\n"
