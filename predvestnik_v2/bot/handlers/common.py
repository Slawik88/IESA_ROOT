...
HELP_PAGES = {
    ...
    "main": (
        ...
        "💰 <b>Экономика</b> — кошелёк, магазин, аукцион, обмен\n"
        "🎲 <b>Гача & Игры</b> — крутка, мини-игры, квесты\n"
        "🐾 <b>Питомцы</b> — зоопарк, кормление, походы\n"
        "👥 <b>Социальное</b> — профиль, брак, варпы, дуэли, топы\n"
        "🌑 <b>Тёмная Мора</b> — контрабанда, ритуал, торговец\n"
        "📦 <b>Предметы</b> — полный каталог с описаниями\n"
        "🎪 <b>Ивенты</b> — сундуки, обмен, акции, торговец\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "⚡ <b>Быстрый старт:</b>\n"
        "<code>бот я</code> · <code>бот баланс</code> · <code>бот зоопарк</code> · <code>бот крутка</code>"
    ),
    ...
    "economy": (
        ...
        "  На что: магазин, гача-яйца, походы, аукцион\n\n"
        "💎 <b>Алмазы</b> — премиум валюта\n"
        "  Откуда: стрик 7/30/100 дней, ивент «Обмен», достижения\n"
        "  На что: гача premium/diamond, особые яйца, корм\n\n"
        "🛒 <b>Магазин</b>\n"
        "▸ <code>бот магазин</code> — яйца, корм, зелья, утилиты\n"
        "▸ <code>бот акция</code> — 5 скидочных лотов каждый день!\n"
        "▸ <code>бот инвентарь</code> — мои предметы\n"
        "▸ <code>бот открыть, [ID яйца] [N]</code> — открыть яйца\n\n"
        ...
        "💱 <b>Обмен</b> — Мора → Алмазы\n"
        "▸ <code>бот обмен</code> — работает только во время ивента!\n"
        "  Курс: 2 000 🪙 = 1 💎 · Дневной лимит: 600 💎\n\n"
        "🎫 <b>Прочее</b>\n"
    ...
    "gacha": (
        ...
        "Виды крутки:\n"
        "🟢 <b>Ученическая</b> — 110 🪙 · Common/Rare · жетон novice\n"
        "🔵 <b>Стандартная</b> — 330 🪙 · Rare/Epic · жетон standard\n"
        "🟣 <b>Премиум</b> — 880 🪙 · Epic/Legendary · жетон premium\n"
        "💎 <b>Алмазная</b> — 3 💎 · Epic/Legendary+ · жетон diamond\n"
        "  💡 Пити — счётчик без-удачи → гарант на редкость!\n"
        "  💡 Жетон крутки = 1 БЕСПЛАТНЫЙ спин (из ивентов, ачивок)\n\n"
        "🎯 <b>Мини-игры</b>\n"
    ...
    "pets": (
        ...
        "▸ <code>бот поход, 2</code> — 2ч · бесплатно · 10–15 🪙 + XP\n"
        "▸ <code>бот поход, 4</code> — 4ч · 15 🪙 · 40–45 🪙 + XP\n"
        "▸ <code>бот поход, 6</code> — 6ч · 25 🪙 · 80–90 🪙 + XP\n"
        "▸ <code>бот поход, 8</code> — 8ч · 35 🪙 · 90–120 🪙 + XP\n"
        ...
        "Epic: 🐺 Волк (блокирует варн) · 🦊 Лиса (шанс 💎 в походе)\n"
        "Leg: 🐉 Дракон (+лимит банка) · 🦄 Единорог (−усталость семьи)\n\n"
        "🥚 <b>Получить питомца</b>\n"
        "Открыть яйцо: <code>бот открыть, egg_basic [N]</code>\n"
        "Яйца покупают в магазине или получают из гачи/ивентов"
    ),
    ...
    "social": (
        ...
        "  💡 В браке доступно 💖 Яйцо Единства — 100% Legendary!\n\n"
        "⚔️ <b>Дуэли</b>\n"
    ...
    "dark": (
        ...
        "  🔴 25% поймали → теряешь всё + бан команды 14 дней!\n\n"
        ...
        "💀 <b>На что тратить 🌑</b>\n"
        "  🏚 Великий Аукцион Теней → Реликвии (редчайшие предметы!)\n"
        "  🖤 Чёрный рынок → теневые темы профиля (эксклюзив)\n"
        "  ⚗️ Испытание Бездны → 5 🌑 вход → реликвия в награду"
    ),
    ...
    "items": (
        ...
        "🥚 <b>ЯЙЦА</b> — открыть: <code>бот открыть, [ID]</code>\n"
        "▸ <code>egg_basic</code> — 🥚 Базовое · 2 500 🪙\n"
        "  📍 Магазин/Гача · 🎯 80% Common · 19% Rare · 1% Epic\n"
        "▸ <code>egg_silver</code> — 🥈 Серебряное · 8 000 🪙\n"
        "  📍 Магазин · 🎯 50%C / 40%R / 10%E\n"
        "▸ <code>egg_gold</code> — 🪙 Золотое · 25 000🪙/150💎\n"
        "  📍 Магазин · 🎯 75%R / 25%E — никаких Common!\n"
        "▸ <code>egg_mythic</code> — 💎 Мифическое · 400 💎\n"
        "  📍 Магазин/Алмазная гача · 🎯 40%R / 60%E\n"
        "▸ <code>egg_unity</code> — 💖 Единства · только семьям\n"
        "  📍 Яйцо семьи · 🎯 100% Legendary!\n"
        "▸ <code>egg_crystal</code> — 🔷 Кристальное\n"
        "  📍 Только из гачи · 🎯 30%E / 70%L — топ-яйцо!\n"
        "▸ <code>egg_daily</code> — 🎁 Яйцо Дня · бесплатно 1/день\n\n"
        "🍖 <b>КОРМ</b> — использовать через <code>бот зоопарк</code>\n"
        "▸ <code>food_basic</code> 🥩 50🪙 — −15 усталости\n"
        "▸ <code>food_elite</code> 🍗 150🪙 — −50 усталости\n"
        "▸ <code>food_energy</code> ⚡ 250🪙 — −20 уст. + сброс КД похода\n"
        "▸ <code>food_super</code> 💊 350🪙 — −60 акт. + −5 всем питомцам\n"
        "▸ <code>food_diamond</code> 💎 8💎 — −100 уст. + 20% эфф. 24ч\n\n"
        "🎟 <b>ЖЕТОНЫ КРУТКИ</b> — 1 бесплатный спин\n"
        "  📍 Ивенты, сундуки, достижения, питомец 🦉 Сова Lv10\n"
        "▸ novice · standard · premium · diamond"
    ),
    ...
    "items2": (
        ...
        "  📍 Гача novice/standard/premium · Как использовать: <code>бот ускорить поход</code>\n"
        ...
        "🧪 <b>ЗЕЛЬЯ ИГРОКА</b>\n"
        "▸ <code>potion_luck_s</code> 🧪 100🪙 — Зелье Удачи (М)\n"
        ...
        "  📍 Гача/распыление питомцев · 5 шт = Яйцо Призыва 🔮\n"
        ...
        "  📍 Гача · Применяется авто → +15% шанс ред.+ в след. яйце\n"
        "▸ <code>study_notes</code> 📚 Конспект · 250🪙\n"
        "  📍 Магазин · Применить: <code>бот зоопарк</code> → +50% XP от сообщ. 4ч\n"
        "▸ <code>slot_expander</code> 🏡 Расширитель · 10💎\n"
        "  📍 Магазин · Постоянно +1 слот питомника (макс. 6 слотов)"
    ),
    ...
    "events": (
        ...
        "  🥇 1 место: 70🪙 + 🎟 жетон · 🥈 2-е: 65🪙 + жетон · 🥉 3-е: 60🪙 + жетон\n"
        "  Место 4-15: 55→10🪙 · Сундук исчезает через 90 сек!\n\n"
        "💱 <b>Ивент: Обмен Моры</b>\n"
        "▸ <code>бот обмен</code> — конвертировать Мору в Алмазы\n"
        "  Работает только пока ивент активен (объявление в чатах)\n"
        "  Курс: 2 000 🪙 = 1 💎 · Дневной лимит: 600 💎\n\n"
        "🛒 <b>Акция дня</b>\n"
