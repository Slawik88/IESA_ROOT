...
THEMES: Dict[str, Dict[str, Any]] = {
    ...
    "theme_royal": {
        "name": "👑 Королевский", "rarity": "legendary", "source": "zarniki", "price_zarniki": 400,
        "top": "👑💎 КОРОЛЕВСКИЙ 💎👑\n═👑═💎═🌟═💎═👑═💎═",
        "sep": "═👑═💎═🌟═💎═👑═💎═",
    ...
    # ── 🔴 MYTHIC ─────────────────────────────────────────────────────────────
    "theme_eclipsed": {
        "name": "🌑🌟 Затмение", "rarity": "mythic", "source": "zarniki", "price_zarniki": 500,
        "top": "🌑🌟 ЗАТМЕНИЕ 🌟🌑\n🌑🌟🌑🌟🌑🌟🌑🌟🌑🌟🌑",
        "sep": "🌑🌟🌑🌟🌑🌟🌑🌟🌑🌟🌑",
        "bot": "🌟 Тьма не победила — она просто пришла в гости…",
        "accent": "🌟",
        "desc": "Солнечное затмение. Мифическая тема из премиум-витрины.",
    },
    "theme_void": {
        # Пустота = абсолютная темнота. 🌌 (галактика) — слишком красочный. Только ⚫🌑
        "name": "⚫ Пустота", "rarity": "mythic", "source": "zarniki", "price_zarniki": 500,
        "top": "⚫🌑 ПУСТОТА 🌑⚫\n⚫ 🌑 ⚫ 🌑 ⚫ 🌑 ⚫ 🌑 ⚫",
        "sep": "⚫ 🌑 ⚫ 🌑 ⚫ 🌑 ⚫ 🌑 ⚫",
        "bot": "⚫ Здесь нет ничего. И именно поэтому — здесь есть всё.",
        "accent": "⚫",
        "desc": "Абсолютный ноль. Мифическая тема из премиум-витрины.",
    },
    ...
    # ── 🗓 SEASONAL ───────────────────────────────────────────────────────────
    "theme_newyear": {
        "name": "🎆 Новый Год", "rarity": "seasonal", "source": "zarniki", "price_zarniki": 250,
        "top": "🎄🎇 ПРОФИЛЬ 🎇🎄\n─✨─🎄─🎇─🎄─✨─🎄─🎇─",
        "sep": "─✨─🎄─🎇─🎄─✨─🎄─🎇─",
    ...
    "theme_summer": {
        "name": "🌻 Солнцестояние", "rarity": "seasonal", "source": "zarniki", "price_zarniki": 250,
        "top": "☀️🌻 ПРОФИЛЬ 🌻☀️\n─☀️─🌻─🌊─🌻─☀️─🌻─",
        "sep": "─☀️─🌻─🌊─🌻─☀️─🌻─",
    ...
    # ── 🔴 MYTHIC ─────────────────────────────────────────────────────────────
    "theme_bloodmoon": {
        "name": "🩸 Кровавая Луна", "rarity": "mythic", "source": "zarniki", "price_zarniki": 500,
        "top": "🩸🌕 КРОВАВАЯ ЛУНА 🌕🩸\n🩸🌕🩸🌕🩸🌕🩸🌕🩸🌕🩸",
        "sep": "🩸🌕🩸🌕🩸🌕🩸🌕🩸🌕🩸",
        "bot": "🌕 Когда небеса багровеют, секреты выходят наружу…",
        "accent": "🩸",
        "desc": "Кровавое полнолуние. Мифическая тема из премиум-витрины.",
    },
    ...
    # ── 🗓 SEASONAL ───────────────────────────────────────────────────────────
    "theme_halloween": {
        "name": "🎃 Самайн", "rarity": "seasonal", "source": "zarniki", "price_zarniki": 250,
        "top": "🎃🦇 ПРОФИЛЬ 🦇🎃\n─🎃─🦇─🕸️─🦇─🎃─🦇─🕸️─",
        "sep": "─🎃─🦇─🕸️─🦇─🎃─🦇─🕸️─",
    ...
    "theme_spring": {
        "name": "💌 Цветение", "rarity": "seasonal", "source": "zarniki", "price_zarniki": 250,
        "top": "💌💘 ПРОФИЛЬ 💘💌\n─💌─💘─🌸─💘─💌─💘─🌸─",
        "sep": "─💌─💘─🌸─💘─💌─💘─🌸─",
    ...
    "theme_luck": {
        "name": "🎰 Азарт", "rarity": "seasonal", "source": "zarniki", "price_zarniki": 250,
        "top": "🎰🃏 ПРОФИЛЬ 🃏🎰\n═♠️═♥️═♣️═♦️═♠️═♥️═",
        "sep": "═♠️═♥️═♣️═♦️═♠️═♥️═",
