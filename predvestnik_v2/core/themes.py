...
THEMES: Dict[str, Dict[str, Any]] = {
    ...
    "theme_dawn":  {"name": "🌅 Рассвет", "rarity": "common", "source": "shop_mora", "price_mora": 200,
                    "accent": "🌅", "top": "🌅━━━━━━━━🌅", "bot": "━━━━━━━━━━", "desc": "Тёплые оранжево-золотые тона."},
    "theme_dusk":  {"name": "🌆 Закат", "rarity": "common", "source": "shop_mora", "price_mora": 200,
                    "accent": "🌆", "top": "🌆━━━━━━━━🌆", "bot": "━━━━━━━━━━", "desc": "Сиреневые тона вечернего неба."},
    "theme_stone": {"name": "🪨 Камень", "rarity": "common", "source": "shop_mora", "price_mora": 150,
                    "accent": "🪨", "top": "🪨▰▰▰▰▰▰▰▰🪨", "bot": "▰▰▰▰▰▰▰▰▰▰", "desc": "Грубые тяжёлые рамки."},
    "theme_leaf":  {"name": "🍃 Лист", "rarity": "common", "source": "shop_mora", "price_mora": 180,
                    "accent": "🍃", "top": "🍃～～～～～～🍃", "bot": "～～～～～～～～", "desc": "Свежая зелёная листва."},
    # ── 🟩 НЕОБЫЧНЫЕ (магазин Алмазы / Обычная гача) — японские + природа ──
    "theme_sakura": {"name": "🌸 Сакура", "rarity": "uncommon", "source": "shop_diamond", "price_diamonds": 15,
                     "gacha": "novice", "accent": "🌸", "top": "🌸❀✿❀✿❀✿❀✿🌸", "bot": "❀✿❀✿❀✿❀✿❀✿", "desc": "Розовые лепестки, японские узоры."},
    "theme_torii":  {"name": "⛩ Тории", "rarity": "uncommon", "source": "shop_diamond", "price_diamonds": 18,
                     "gacha": "novice", "accent": "⛩", "top": "⛩━━━━━━━━⛩", "bot": "🏮━━━━━━━━🏮", "desc": "Красные врата синтоистского храма."},
    "theme_koi":    {"name": "🎏 Карпы Кои", "rarity": "uncommon", "source": "shop_diamond", "price_diamonds": 16,
                     "gacha": "novice", "accent": "🎏", "top": "🎏〰〰〰〰〰〰🎏", "bot": "〰〰〰〰〰〰〰〰", "desc": "Плывущие карпы, японский вымпел."},
    "theme_autumn": {"name": "🍂 Осень", "rarity": "uncommon", "source": "shop_diamond", "price_diamonds": 15,
                     "gacha": "novice", "accent": "🍂", "top": "🍂🍁🍂🍁🍂🍁🍂🍁", "bot": "🍁🍂🍁🍂🍁🍂🍁🍂", "desc": "Оранжево-красные листья."},
    "theme_ocean":  {"name": "🌊 Океан", "rarity": "uncommon", "source": "shop_diamond", "price_diamonds": 15,
                     "gacha": "novice", "accent": "🌊", "top": "🌊≈≈≈≈≈≈≈≈🌊", "bot": "≈≈≈≈≈≈≈≈≈≈", "desc": "Синие волны, пенные завитки."},
    "theme_snow":   {"name": "❄️ Снег", "rarity": "uncommon", "source": "shop_diamond", "price_diamonds": 15,
                     "gacha": "novice", "accent": "❄️", "top": "❄️•❄️•❄️•❄️•❄️", "bot": "•❄️•❄️•❄️•❄️•", "desc": "Снежинки, ледяные кристаллы."},
    # ── 🟦 РЕДКИЕ (магазин Алмазы / Стандартная гача) ──
    "theme_fuji":   {"name": "🗻 Фудзи", "rarity": "rare", "source": "shop_diamond", "price_diamonds": 60,
                     "gacha": "standard", "accent": "🗻", "top": "🗻▲△▲△▲△▲△🗻", "bot": "△▲△▲△▲△▲△▲", "desc": "Священная гора в облаках."},
    "theme_fire":   {"name": "🔥 Пламя", "rarity": "rare", "source": "shop_diamond", "price_diamonds": 50,
                     "gacha": "standard", "accent": "🔥", "top": "🔥◢◣◢◣◢◣◢◣🔥", "bot": "◣◢◣◢◣◢◣◢◣◢", "desc": "Языки огня, пульсирующий оранжевый."},
    "theme_ice":    {"name": "🧊 Лёд", "rarity": "rare", "source": "shop_diamond", "price_diamonds": 50,
                     "gacha": "standard", "accent": "🧊", "top": "🧊◇◆◇◆◇◆◇◆🧊", "bot": "◆◇◆◇◆◇◆◇◆◇", "desc": "Острые ледяные узоры."},
    "theme_storm":  {"name": "⚡ Буря", "rarity": "rare", "source": "shop_diamond", "price_diamonds": 55,
                     "gacha": "standard", "accent": "⚡", "top": "⚡╱╲╱╲╱╲╱╲⚡", "bot": "╲╱╲╱╲╱╲╱╲╱", "desc": "Молнии по контуру, грозовое небо."},
    "theme_moon":   {"name": "🌙 Лунная", "rarity": "rare", "source": "shop_diamond", "price_diamonds": 50,
                     "gacha": "standard", "accent": "🌙", "top": "🌙✦˚✦˚✦˚✦˚🌙", "bot": "˚✦˚✦˚✦˚✦˚✦", "desc": "Полумесяц и звёзды, серебро."},
    "theme_cherry": {"name": "🌺 Алая Вишня", "rarity": "rare", "source": "shop_diamond", "price_diamonds": 60,
    ...
    "theme_dark_trade": {"name": "💀 Теневой Торговец", "rarity": "shadow", "source": "dark", "price_dark": 80,
                         "accent": "💀", "top": "💀†☠†☠†☠†☠💀", "bot": "†☠†☠†☠†☠†☠", "desc": "Силуэт торговца Чёрного рынка."},
    "theme_forbidden":  {"name": "🔒 Запретный", "rarity": "shadow", "source": "dark", "price_dark": 120,
                         "accent": "🔒", "top": "🔒⛓⛓⛓⛓⛓⛓⛓🔒", "bot": "⛓⛓⛓⛓⛓⛓⛓⛓⛓", "desc": "Цепи и замки по рамке."},
    "theme_banished":   {"name": "👁 Изгнанник", "rarity": "shadow", "source": "dark", "price_dark": 150,
