...
ACHIEVEMENTS: Dict[str, Dict] = {
    ...
    "fashionista": {
        ...
        "thresholds": [1, 3, 5, 8, 12, 18, 26, 38, 52, 70],
        "desc": "Купите N предметов косметики (ореолы, рамки, гало, фоны, частицы, "
                "титулы) во «Внешнем виде». Засчитывается и вся косметика, что у вас "
                "уже есть — прогресс подтянется при открытии достижений.",
    },
    "gate_conqueror": {
