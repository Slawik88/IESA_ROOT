...
ITEMS_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    # ── БЛОК21 #3: осколки косметик-крафта + сундуки-сюрпризы (за ⭐) ──
    "cosmetic_shard": {
    ...
    "chest_mini": {
        "name": "🎁 Мини-сюрприз",
        "category": "chest",
        "description": "Маленький сундук за ⭐: случайный расходник или осколки косметики. Открыть: Внешний вид → 🎁 Сюрпризы.",
        "is_tradable": False,
    },
    "chest_style": {
        "name": "🎁 Сундук Стиля",
        "category": "chest",
        "description": "Сундук за ⭐: косметика (common/rare/epic), дубль → осколки. Открыть: Внешний вид → 🎁 Сюрпризы.",
        "is_tradable": False,
    },
