...
GACHA_TABLES: Dict[str, list] = {
    "novice": [
        {"weight": 28, "type": "mora",    "min": 20,  "max": 50},
        {"weight": 18, "type": "item",    "id": "food_basic",   "qty": 1},
        {"weight": 12, "type": "item",    "id": "star_dust_s",  "qty": 1},
        {"weight": 10, "type": "item",    "id": "soul_shard",   "qty": 1},
        {"weight": 10, "type": "mora",    "min": 60,  "max": 90},
    ...
    "standard": [
        {"weight": 22, "type": "mora",    "min": 60,  "max": 150},
        {"weight": 15, "type": "item",    "id": "food_elite",   "qty": 1},
    ...
    "diamond": [
        {"weight": 25, "type": "item",    "id": "egg_gold",     "qty": 1, "valuable": True},
        {"weight": 18, "type": "item",    "id": "egg_mythic",   "qty": 1, "valuable": True},
        {"weight": 15, "type": "combo",   "items": [{"id": "egg_silver", "qty": 1}], "diamond_bonus": 2, "valuable": True},
        {"weight": 12, "type": "pet_dup", "rarity": "epic",     "valuable": True},
