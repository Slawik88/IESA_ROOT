...
- Подключено к покупке слота питомника (референс-интеграция). Распространение на
  магазин/гачу/темы/VIP — тот же one-line враппер (каждая со своим confirm-flow,
  раскатывать по мере надобности, чтобы не ломать их UX без тестов на БД).
