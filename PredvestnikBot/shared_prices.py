...
# ─── Магазин кристаллов: эксклюзивная косметика за 💎 ────────────────────────
...
TALENT_TREE = {
    ...
    "drop_luck":       {"name": "Охотничья удача",        "emoji": "🍀",  "tier": 1, "max_level": 7,
                        "desc": "+1% к шансу выпасть предметам из сундуков, рулетки и ивентов.",
    ...
    "expedition_haste":{"name": "Ускорение экспедиций",   "emoji": "🗺️",  "tier": 1, "max_level": 5,
                        "desc": "Снижает минимальное время экспедиции на 5 мин.",
                        "effect_key": "expedition_cd_minutes", "effect_per_level": 5},
    "reputation_flow": {"name": "Репутационный поток",    "emoji": "⭐",  "tier": 1, "max_level": 5,
                        "desc": "Снижает кулдаун выдачи репутации на 1 ч.",
                        "effect_key": "rep_cd_hours",       "effect_per_level": 1},
    # ── Tier 2 — продвинутые (требуют 5+ очков в T1) ────────────────────────
    "lucky_strike":    {"name": "Счастливый удар",        "emoji": "🎲",  "tier": 2, "max_level": 6,
                        "desc": "+2% шанс выигрыша при монетке/дуэли.",
                        "effect_key": "coinflip_win_pct",   "effect_per_level": 2},
    ...
    "craft_mastery":   {"name": "Мастерство крафта",      "emoji": "⚒️",  "tier": 3, "max_level": 5,
                        "desc": "Снижает кол-во шардов для крафта предметов на 1.",
