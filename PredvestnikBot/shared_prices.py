...
COSMETICS_CATALOG = [
    ...
    ("expedition_boost",  "🗺️",  "Экспедиционный допинг",   600,  "+20% к наградам экспедиции (3 использования)"),
    ("mora_shield",       "💰",  "Щит Моры",                800,  "Не терять мору при первой потере в казино за день"),
