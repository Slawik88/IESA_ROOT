#!/usr/bin/env python3
"""
Скрипт миграции данных из истории Telegram-чата в базу Predvestnik.
...
Что делает:
  ...
  5. Если указан --marriages: читает файл и импортирует браки в таблицу marriages

Использование:
  python migrate_from_iris.py \\
      --api-id 12345678 \\
