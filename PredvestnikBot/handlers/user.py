...
def _help_sections() -> list[tuple[str, str, str, str, str]]:
    ...
    return [
        (
            ...
            "🚨 <b>Жалобы</b>\n"
            "  <code>бот жалоба [причина]</code> — анонимная жалоба (ответом)",
        ),
        (
    ...
    return {
        "mod": [
            ...
            (
                ...
                "🔁 <b>Автоответы</b>\n"
                "  <code>бот автоответ [фраза] | [ответ]</code> — задать авто-ответ\n"
                ...
                "  <code>бот чс</code> — список запрещённых слов\n\n"
                "🚪 <b>Покинувшие чат</b>\n"
                "  <code>бот ушли [N]</code> — последние N покинувших чат",
            ),
            (
