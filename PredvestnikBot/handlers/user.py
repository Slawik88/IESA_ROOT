...
def _help_sections() -> list[tuple[str, str, str, str, str]]:
    ...
    return [
        ...
        (
            ...
            "  💍 Годовщины брака — +15 🪙 каждому партнёру (каждые 7 дней)\n"
            "  💎 Еженедельный бонус одиночки — +10 🪙 каждое воскресенье\n"
            "  🎰 Казино: победа в монетке или дуэли\n"
            "  🎟 Лотерея: удача (5% шанс выиграть 20–50 🪙)\n\n"
            ...
            "🔐 <b>Секретные сообщения</b>\n"
            "  <code>бот секрет @user текст</code> — сообщение только для получателя <i>(25 🪙)</i>\n\n"
            "🎯 <b>Задания</b>\n"
